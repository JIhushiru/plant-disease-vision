...
export default function ErrorMessage({ message, onRetry }) {
  return (
    <motion.div
      ...
      className="bg-danger-50 border border-danger-200 rounded-2xl p-5"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {onRetry && (
            <button
              onClick={onRetry}
              className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-danger-700 hover:text-danger-900 transition-colors"
            >
